...
parser.add_argument('--info_file', required=True, type=str)#数据信息文件路径 data/info.txt
parser.add_argument('--val_ratio', type=float, default=0.2)#验证集比例20%
parser.add_argument('--cat_loc', type=int, default=1)# 文件路径中类别所在位置 cat=category
